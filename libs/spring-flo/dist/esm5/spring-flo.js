...
var Utils = /** @class */ (function () {
    ...
    Utils.fanRoute = function (graph, cell) {
        if (cell instanceof joint$2.dia.Element) {
            chain(graph.getConnectedLinks(cell)).groupBy(function (link) {
        ...
        var siblings = filter(graph.getLinks(), function (sibling) {
        ...
        switch (siblings.length) {
            ...
            default:
                ...
                var gap_1 = 20;
                each(siblings, function (sibling, index) {
...
var EditorComponent = /** @class */ (function () {
    ...
    EditorComponent.prototype.ngOnInit = function () {
        ...
        this._disposables.add(Disposable.create(function () { return $$3(window).off('resize', _this._resizeHandler); }));
...
var ResizerDirective = /** @class */ (function () {
    ...
    ResizerDirective.prototype.ngOnInit = function () {
        ...
        var subscription1 = Observable.fromEvent($$4(this.document).get(0), 'mousemove')
            .pipe(sampleTime(300))
            .subscribe(this.mouseMoveHandler);
        this._subscriptions.add(Disposable.create(function () { return subscription1.unsubscribe(); }));
        var subscription2 = Observable.fromEvent($$4(this.document).get(0), 'mouseup')
